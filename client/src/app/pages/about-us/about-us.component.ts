...
export class AboutUsComponent {
  ...
  photos: Photo[] = [
    { imageUrl: 'images/dietitianSign.jpg', caption: 'Welcome to Our Nutrition Center' },
    { imageUrl: 'images/dietitian.jpg', caption: 'Your Dedicated Nutrition Professional' },
    { imageUrl: 'images/specialEquipment.jpg', caption: 'Latest Models of Body Composition Analyzers' },
